...
$bHelp = (true == Utils::ReadBooleanParameter('help', false));
...
$bConfigureOnly = (true == Utils::ReadBooleanParameter('configure_only', false));
$bCollectOnly = (true == Utils::ReadBooleanParameter('collect_only', false));
$bSynchroOnly = (true == Utils::ReadBooleanParameter('synchro_only', false));
$bDumpConfigOnly = (true == Utils::ReadBooleanParameter('dump_config_only', false));
